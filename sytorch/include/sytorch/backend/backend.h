...
public:
    ...
    virtual void gelu(const Tensor<T> &in, const Tensor<T> &out, u64 scale, u64 mode = 0) NOT_IMPLEMENTED;
    virtual void silu(const Tensor<T> &in, const Tensor<T> &out, u64 scale, u64 mode = 0) NOT_IMPLEMENTED;
    ...
    virtual void sin(const Tensor<T> &in, const Tensor<T> &out, u64 scale) NOT_IMPLEMENTED;
    virtual void cos(const Tensor<T> &in, const Tensor<T> &out, u64 scale) NOT_IMPLEMENTED;
    virtual void rotate_half(Tensor<T> &x, Tensor<T> &y) NOT_IMPLEMENTED;
    virtual void rotary_embedding_before_sin_cos(Tensor<T> &x, Tensor<T> &y, u64 scale, u64 max_position_embeddings=2048, u64 base=10000) NOT_IMPLEMENTED;
